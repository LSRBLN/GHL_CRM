    ...
    return (
      <div className="flex items-center justify-center py-20">
        <div className="text-center">
          ...
          <p className="text-gray-500" data-testid="audit-report-loading-text">Bericht wird erstellt...</p>
        </div>
      </div>
    );
  }
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="text-gray-700" data-testid="audit-report-mobile-issues">{report.website_performance.mobile_issues} Sollte behoben werden</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <AlertTriangle size={14} className="text-amber-500" />
                      <span className="text-gray-700" data-testid="audit-report-mobile-warnings">{report.website_performance.mobile_warnings} Erwägen Sie eine Behebung</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      <CheckCircle2 size={14} className="text-green-500" />
                      <span className="text-gray-700" data-testid="audit-report-desktop-passed">{report.website_performance.desktop_passed} Test erfolgreich</span>
                    </div>
                  </div>
                </div>
              </>
