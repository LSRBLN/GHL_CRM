  ...
  if (error || !report) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="text-gray-700 font-medium">{error || 'Bericht nicht verfügbar'}</p>
        ...
        {expandedSections.listings && (
          <CardContent className="pt-0 pb-5 px-5">
            <div className="flex items-center gap-6 mb-4">
              <ScoreCircle score={report.listings.score} size={80} strokeWidth={6} />
              <div className="flex-1">
              ...
              <div className="flex-1">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  ...
                  <div className="p-3 rounded-lg bg-red-50 border border-red-200 text-center">
                    ...
                    <p className="text-xl font-bold text-red-700">{report.reputation.negative_reviews}</p>
                  </div>
                </div>
